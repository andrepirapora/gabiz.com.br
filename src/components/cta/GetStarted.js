...
export default ({
  text = 'Profissionais de todo o Brasil usam o Gabiz.',
  primaryLinkText = 'Começar',
  primaryLinkUrl = 'https://play.google.com/store/apps/details?id=com.gabiz.gabiz',
  secondaryLinkText = 'Contate-nos',
